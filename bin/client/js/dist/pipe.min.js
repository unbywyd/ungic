...
"use strict";var _socket=_interopRequireDefault(require("socket.io-client"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}document.addEventListener("DOMContentLoaded",function(){var e=document.querySelector("[data-connect]").getAttribute("data-connect"),t=(0,_socket.default)(e),r=performance.getEntriesByType("resource"),n=document.querySelector("[data-connect]").getAttribute("data-src");t.on("change",function(e,t,o){if(o==n)return console.log("this page has been changed."),window.location.reload();var a=!0,i=!1,l=void 0;try{for(var c,u=r[Symbol.iterator]();!(a=(c=u.next()).done);a=!0){var d=c.value;if(d.name==t)if("link"==d.initiatorType){var f=document.querySelectorAll('[href*="'+o+'"]');if(f.length){var s=!0,y=!1,v=void 0;try{for(var h,g=f[Symbol.iterator]();!(s=(h=g.next()).done);s=!0){h.value.setAttribute("href",t+"?v="+Date.now()),console.log("".concat(o," has been updated"))}}catch(e){y=!0,v=e}finally{try{s||null==g.return||g.return()}finally{if(y)throw v}}}}else window.location.reload()}}catch(e){i=!0,l=e}finally{try{a||null==u.return||u.return()}finally{if(i)throw l}}})});
...
},{"base64-js":6,"buffer":9,"ieee754":29}],10:[function(require,module,exports){
...
},{"./common":14,"_process":35}],14:[function(require,module,exports){
...
},{"./transport":17,"./transports/index":18,"component-emitter":11,"debug":13,"engine.io-parser":24,"indexof":30,"parseqs":33,"parseuri":34}],17:[function(require,module,exports){
...
},{"../transport":17,"component-inherit":12,"debug":13,"engine.io-parser":24,"parseqs":33,"xmlhttprequest-ssl":23,"yeast":48}],22:[function(require,module,exports){
(function (Buffer){
...
},{"../transport":17,"buffer":9,"component-inherit":12,"debug":13,"engine.io-parser":24,"parseqs":33,"ws":8,"yeast":48}],23:[function(require,module,exports){
...
},{"./keys":25,"./utf8":26,"after":2,"arraybuffer.slice":3,"base64-arraybuffer":5,"blob":7,"has-binary2":27}],25:[function(require,module,exports){
...
},{"buffer":9,"isarray":31}],28:[function(require,module,exports){
...
},{"./manager":37,"./socket":39,"./url":40,"debug":13,"socket.io-parser":43}],37:[function(require,module,exports){
...
},{"./on":38,"./socket":39,"backo2":4,"component-bind":10,"component-emitter":11,"debug":13,"engine.io-client":15,"indexof":30,"socket.io-parser":43}],38:[function(require,module,exports){
...
},{"./on":38,"component-bind":10,"component-emitter":11,"debug":13,"has-binary2":27,"parseqs":33,"socket.io-parser":43,"to-array":47}],40:[function(require,module,exports){
...
},{"./binary":42,"./is-buffer":44,"component-emitter":11,"debug":45,"isarray":31}],44:[function(require,module,exports){
(function (Buffer){
...
},{"./debug":46,"_process":35}],46:[function(require,module,exports){
...
},{"ms":41}],47:[function(require,module,exports){

...
"use strict";var _jsonTreeView=_interopRequireDefault(require("json-tree-view")),_socket=_interopRequireDefault(require("socket.io-client"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}document.addEventListener("DOMContentLoaded",function(){var e=document.querySelectorAll(".un-debug");if(e.length){var t=!0,r=!1,n=void 0;try{for(var o,a=e[Symbol.iterator]();!(t=(o=a.next()).done);t=!0){var l=o.value,i=l.innerHTML;try{var u=JSON.parse(i),c=l.getAttribute("data-path");c||(c="debug");var d=new _jsonTreeView.default(c,u);l.style.display="none";var f=document.createElement("div");f.setAttribute("class","jsonViewWrap"),f.appendChild(d.dom),l.parentNode.insertBefore(f,l),d.expand(!0),d.readonly=!0}catch(e){console.log(e)}}}catch(e){r=!0,n=e}finally{try{t||null==a.return||a.return()}finally{if(r)throw n}}}var s=document.querySelector("[data-connect]").getAttribute("data-connect"),y=(0,_socket.default)(s),v=performance.getEntriesByType("resource"),h=document.querySelector("[data-connect]").getAttribute("data-src");y.on("change",function(e,t,r){if(r==h)return console.log("this page has been changed."),window.location.reload();var n=!0,o=!1,a=void 0;try{for(var l,i=v[Symbol.iterator]();!(n=(l=i.next()).done);n=!0){var u=l.value;if(u.name==t)if("link"==u.initiatorType){var c=document.querySelectorAll('[href*="'+r+'"]');if(c.length){var d=!0,f=!1,s=void 0;try{for(var y,p=c[Symbol.iterator]();!(d=(y=p.next()).done);d=!0){y.value.setAttribute("href",t+"?v="+Date.now()),console.log("".concat(r," has been updated"))}}catch(e){f=!0,s=e}finally{try{d||null==p.return||p.return()}finally{if(f)throw s}}}}else window.location.reload()}}catch(e){o=!0,a=e}finally{try{n||null==i.return||i.return()}finally{if(o)throw a}}})});
